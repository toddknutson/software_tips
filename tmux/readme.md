...
I am using some special flags in my `ssh` commands (e.g. `-Y -A -t -X -C`) or my `srun` commands (e.g. `--x11`) to allow for X11 forwarding (you may want or not need these flags?). 
